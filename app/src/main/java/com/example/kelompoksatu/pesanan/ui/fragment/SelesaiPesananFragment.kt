...
import com.example.kelompoksatu.pesanan.adapter.SelesaiPesananAdapter
...
class SelesaiPesananFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentSelesaiPesananBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun getData() {
        query = FirebaseDatabase.getInstance().getReference("pesanan")
                .orderByChild("statusPembayaran").equalTo("Terbayar")
