...
import com.example.user.databinding.ActivitySumbarBinding
import com.example.user.paket.adapter.PaketAdapter
import com.example.user.paket.model.Paket
import com.google.firebase.database.*

class SumbarActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySumbarBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySumbarBinding.inflate(layoutInflater)
        setContentView(binding.root)

        paketRecyclerView = binding.rvSumbar
