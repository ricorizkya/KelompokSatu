...
import com.example.user.databinding.ActivityJambiBinding
import com.example.user.paket.adapter.PaketAdapter
import com.example.user.paket.model.Paket
import com.google.firebase.database.*

class JambiActivity : AppCompatActivity() {

    private lateinit var binding: ActivityJambiBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityJambiBinding.inflate(layoutInflater)
        setContentView(binding.root)

        paketRecyclerView = binding.rvJambi
